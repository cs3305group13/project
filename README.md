...
## **Section 4 - Features Needing Fixing**
  ...
  * ### **Bugs**
    * During testing it was seen users using a Safari browser would be kicked after some time for being idle whereas browsers like Google Chrome, Brave Browser and FireFox would be mostly unaffected. This may be due to ajax http request prioritisation given to the default browser we had select (google chrome).
